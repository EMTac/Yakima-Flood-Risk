...
map.fitWorld();
map.setView([46.59256356403898, -120.54743687141388], 13);
...
var yFloods_AE = L.geoJSON(floods, {
  filter: function(feature, layer) {
    return feature.properties.FLD_ZONE === 'AE' && feature.properties.ZONE_SUBTY === ' ';
  },
  style: {
    fillColor: '#318BFF',
    fillOpacity: 0.5,
...
var yFloods_NOT_INCLUDED = L.geoJSON(floods, {
  filter: function(feature, layer) {
    return feature.properties.FLD_ZONE === 'AREA NOT INCLUDED';
  },
  style: {
    fillColor: '#FFBEBE',
    fillOpacity: 0.5,
...
var yFloods_X_MINIMAL = L.geoJSON(floods, {
  filter: function(feature, layer) {
    return feature.properties.FLD_ZONE === 'X' && feature.properties.ZONE_SUBTY === 'AREA OF MINIMAL FLOOD HAZARD';
  },
  style: {
    fillColor: '#EDEDED',
    fillOpacity: 0,
...
var yFloods_X_LEVEE = L.geoJSON(floods, {
  filter: function(feature, layer) {
    return feature.properties.FLD_ZONE === 'X' && feature.properties.ZONE_SUBTY === 'AREA WITH REDUCED FLOOD RISK DUE TO LEVEE';
  },
  style: {
    fillColor: '#A598FE',
    fillOpacity: 0.5,
...
const floodGroup = L.layerGroup([yFloods_A,yFloods_AE,yFloods_AE_FLOODWAY,yFloods_D,yFloods_NOT_INCLUDED,yFloods_X_02PCT,yFloods_X_LEVEE,yFloods_X_MINIMAL, ySurfaceWater], {
}).addTo(map);
...
var legend = L.control.Legend({
  ...
  legends: [
    ...
    {
      label: "Risk Mitigated by Levee",
      type: "rectangle",
      layers: yFloods_X_LEVEE,
      color: "#A598FE",
      fill: true,
      fillOpacity: "0.5"
    },
